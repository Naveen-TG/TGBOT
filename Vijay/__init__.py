...
# Bot information
SESSION = environ.get('SESSION', 'ActorVijay')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001903548258'))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001609632535')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001983581753')).split()]  # For Multiple Id Use One Space Between Each.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph/ce1723991756e48c35aa1.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/itamilMV1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/VijayTG_Updates')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'VijayTG_Support') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Naveen_TG')
