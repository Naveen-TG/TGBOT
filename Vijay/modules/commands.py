...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for x in filesarr:
            await x.delete()
        await k.edit_text("<b>Your Files are successfully deleted!!!</b>")  
        return
